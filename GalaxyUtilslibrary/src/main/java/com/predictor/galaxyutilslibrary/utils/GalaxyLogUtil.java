package com.predictor.galaxyutilslibrary.utils;
...
public abstract class GalaxyLogUtil {
	...
	public static void setTimeEnd(String content) {
		...
		if (!allowI || ValidatorUtil.isEmpty(content+ time)) {
			return;
		}
		StackTraceElement caller = getCallerMethodName();
		String tag = generateTag(caller);
